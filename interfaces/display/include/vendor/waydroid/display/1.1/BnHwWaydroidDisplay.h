#ifndef HIDL_GENERATED_VENDOR_WAYDROID_DISPLAY_V1_1_BNHWWAYDROIDDISPLAY_H
#define HIDL_GENERATED_VENDOR_WAYDROID_DISPLAY_V1_1_BNHWWAYDROIDDISPLAY_H
...
struct BnHwWaydroidDisplay : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_setLayerSize(
    ...
    static ::android::status_t _hidl_setTargetLayerSize(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_VENDOR_WAYDROID_DISPLAY_V1_1_BNHWWAYDROIDDISPLAY_H
