#ifndef HIDL_GENERATED_VENDOR_WAYDROID_DISPLAY_V1_1_BPHWWAYDROIDDISPLAY_H
#define HIDL_GENERATED_VENDOR_WAYDROID_DISPLAY_V1_1_BPHWWAYDROIDDISPLAY_H

#include <hidl/HidlTransportSupport.h>

#include <vendor/waydroid/display/1.1/IHwWaydroidDisplay.h>
...
struct BpHwWaydroidDisplay : public ::android::hardware::BpInterface<IWaydroidDisplay>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::graphics::composer::V2_1::Error>  _hidl_setLayerSize(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t layer, uint32_t width, uint32_t height);
    static ::android::hardware::Return<::android::hardware::graphics::composer::V2_1::Error>  _hidl_setTargetLayerSize(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t width, uint32_t height);
...
#endif  // HIDL_GENERATED_VENDOR_WAYDROID_DISPLAY_V1_1_BPHWWAYDROIDDISPLAY_H
