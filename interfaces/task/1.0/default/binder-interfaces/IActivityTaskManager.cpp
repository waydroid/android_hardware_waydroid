...
::android::binder::Status IActivityTaskManagerDefault::setFocusedTask(int32_t) {
...
::android::binder::Status BpActivityTaskManager::setFocusedTask(int32_t taskId) {
...
::android::binder::Status BpActivityTaskManager::removeTask(int32_t taskId, bool* _aidl_return) {
  ...
  _aidl_ret_status = remote()->transact(::android::IBinder::FIRST_CALL_TRANSACTION + 22 /* removeTask */, _aidl_data, &_aidl_reply);
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  _aidl_ret_status = _aidl_status.readFromParcel(_aidl_reply);
...
::android::binder::Status BpActivityTaskManager::removeAllVisibleRecentTasks() {
  ...
  _aidl_ret_status = remote()->transact(::android::IBinder::FIRST_CALL_TRANSACTION + 23 /* removeAllVisibleRecentTasks */, _aidl_data, &_aidl_reply);
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  _aidl_ret_status = _aidl_status.readFromParcel(_aidl_reply);
...
::android::status_t BnActivityTaskManager::onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) {
  ...
  case ::android::IBinder::FIRST_CALL_TRANSACTION + 20 /* setFocusedTask */:
  {
    ...
    ::android::binder::Status _aidl_status(setFocusedTask(in_taskId));
  ...
  break;
  case ::android::IBinder::FIRST_CALL_TRANSACTION + 22 /* removeTask */:
  {
    int32_t in_taskId;
    bool _aidl_return;
    if (!(_aidl_data.checkInterface(this))) {
  ...
  break;
  case ::android::IBinder::FIRST_CALL_TRANSACTION + 23 /* removeAllVisibleRecentTasks */:
  {
    if (!(_aidl_data.checkInterface(this))) {
      _aidl_ret_status = ::android::BAD_TYPE;
      break;
